  ...
  return (
    <>
      <DefaultLayout>
        ...
        {/* Loading Animation */}
        <h1>lenght is : {cars.length}</h1>
        <div className="border-none p-8 mx-auto rounded-md p-4 max-w-3xl w-full">
          <div className="animate-pulse flex space-x-4">
            <div className="rounded-sm bg-slate-300 h-28 w-28"></div>
            <div className="flex-1 space-y-6 py-1">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div className="h-2 mt-1 bg-slate-300 rounded col-span-1"></div>
                  <div className="h-2 mt-1 bg-slate-300 rounded col-span-1"></div>
                  <div className="h-2 mt-1 bg-slate-300 rounded col-span-1"></div>
                </div>
              </div>
